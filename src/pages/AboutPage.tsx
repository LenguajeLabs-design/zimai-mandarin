  ...
  return (
    <div className="page page--about">
      ...
      <section className="about-grid" aria-label="Collection notes">
        ...
        <article className="about-card"><p className="eyebrow">Audio</p><h2>Pronunciation stays close.</h2><p>The prototype uses the browser’s Mandarin speech-synthesis fallback. Reviewed local recordings can be added later without changing the map or content model.</p></article>
