    ...
    <div className="page page--review">
      ...
      <div className="review-layout">
        <section className="review-card" aria-labelledby="review-word-heading">
          ...
          <div className="review-card__meta"><StatusBadge label={current.hskLevel} />{learnedWords.includes(current.id) && <span className="review-card__learned">✓ learned</span>}<AudioButton audioKey={current.audioKey} text={current.hanzi} playingKey={audio.playingKey} onPlay={audio.onPlay} onStop={audio.onStop} label={`Play audio for ${current.hanzi}, ${current.gloss}`} /></div>
