...
export const siteCopy = {
  en: {
    ...
    library: {
      ...
      startTitle: 'Start a small thread.',
      startDescription: 'Open one map, learn one word, and let the next connection decide where you go.',
      startWithFeatured: 'Start with this map',
      learned: 'learned',
      learnedSet: 'learned in this set',
      continue: 'Continue',
      yourShelf: 'Your shelf',
      ...
      returnToWords: 'Return to a few words while they are still warm.',
      returnToMap: 'Review a few words',
      explore: 'Explore the collection',
      moreWays: 'More ways in.',
    ...
    review: { eyebrow: 'A small, low-pressure loop', titleFirst: 'Make a little', titleSecond: 'space to remember.', description: 'Listen, notice the recurring character, and move on when the word feels familiar.', ready: 'ready now', savedSource: 'From your saved words', starterSource: 'A starter set from the library', learned: 'learned', learnedSet: 'learned in this set', play: 'Play audio for', context: 'See it in context', again: 'Needs another look', good: 'I know it', manual: 'Mark learned manually', marked: 'Marked learned', smallSet: 'Your small set', keepThread: 'Keep the thread.', learnedMark: 'Learned', newReady: 'New · ready now', readyAgain: 'Ready for another look', nextTomorrow: 'Next review tomorrow', nextDays: 'Next review in', previous: 'Previous' },
  ...
  ko: {
    ...
    library: {
      ...
      startTitle: '작은 연결부터 시작하세요.',
      startDescription: '지도 하나를 열고 단어 하나를 익힌 뒤, 다음 연결을 따라가 보세요.',
      startWithFeatured: '이 지도부터 시작',
      learned: '학습 완료',
      learnedSet: '이 세트에서 학습함',
      continue: '이어 하기',
      yourShelf: '내 서재',
      savedMaps: '저장한 지도',
    ...
    review: { eyebrow: '작고 부담 없는 복습 루프', titleFirst: '기억할 공간을', titleSecond: '조금 만들어 보세요.', description: '듣고, 반복되는 글자를 살펴보고, 익숙해지면 다음 단어로 넘어가세요.', ready: '지금 복습할 단어', savedSource: '저장한 단어에서', starterSource: '라이브러리의 시작 세트', learned: '학습 완료', learnedSet: '이 세트에서 학습함', play: '오디오 재생', context: '문맥에서 보기', again: '한 번 더 보기', good: '알겠어요', manual: '배운 단어로 직접 표시', marked: '배운 단어로 표시됨', smallSet: '나의 작은 세트', keepThread: '연결을 이어 가세요.', learnedMark: '학습 완료', newReady: '새 단어 · 지금 시작', readyAgain: '다시 볼 시간입니다', nextTomorrow: '내일 다시 보기', nextDays: '일 후 다시 보기', previous: '이전' },
