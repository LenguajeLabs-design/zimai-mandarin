...
export const siteCopy = {
  en: {
    app: {
      ...
      nav: { families: 'Maps', review: 'Review', saved: 'Saved', search: 'Search', hsk: 'HSK' },
      languageLabel: 'Explanation language',
      english: 'English',
      korean: '한국어',
      ...
      hskReference: 'HSK vocabulary',
      hskBrowseAll: 'Browse all',
      hskExplore: 'Words to explore',
      hskExploreDescription: 'Outside a family map',
    },
    library: {
      ...
      hsk: {
      eyebrow: 'Reference library · HSK 1–6',
      title: 'HSK vocabulary.',
      description: 'Browse the full HSK 1–6 reference, then find the words waiting for a family map.',
      wordCount: 'words in this reference',
      sourcePrefix: 'Source:',
      sourceName: 'HSK东西 word lists',
      viewLabel: 'Vocabulary view',
      all: 'All HSK words',
      explore: 'Words to explore',
      exploreEyebrow: 'Family map coverage',
      exploreTitle: 'Words outside the maps.',
      exploreEmptyTitle: 'Every word has a map.',
      exploreDescription: 'Words without a family map live here until we give them a useful connection.',
      openExplore: 'Open this view',
      showAll: 'Show all HSK words',
      levelLabel: 'Filter by level',
      allLevels: 'All levels',
      groupEyebrow: 'HSK reference',
      words: 'words',
      noMatches: 'No HSK words match that search.',
      noMatchesDescription: 'Try a different character, pinyin, level, or English explanation.',
      reset: 'Reset filters',
    },
  ...
  ko: {
    app: {
      ...
      primaryNav: '주요 메뉴',
      mobileNav: '모바일 메뉴',
      nav: { families: '단어 지도', review: '복습', saved: '저장', search: '검색', hsk: 'HSK' },
      languageLabel: '설명 언어',
      english: 'English',
      korean: '한국어',
      useLight: '라이트 모드 사용',
      ...
      hskBrowseAll: '전체 보기',
      hskExplore: '살펴볼 단어',
      hskExploreDescription: '단어 지도 밖의 단어',
    },
    library: {
      ...
      hsk: {
      eyebrow: '참고 라이브러리 · HSK 1–6',
      title: 'HSK 단어.',
      description: '전체 HSK 1–6 참고 목록을 살펴보고, 아직 단어 지도로 연결되지 않은 단어를 찾아보세요.',
      wordCount: '개 단어가 있습니다',
      sourcePrefix: '출처:',
      sourceName: 'HSK东西 단어 목록',
      viewLabel: '단어 보기',
      all: '전체 HSK 단어',
      explore: '살펴볼 단어',
      exploreEyebrow: '단어 지도 연결 상태',
      exploreTitle: '단어 지도 밖의 단어.',
      exploreEmptyTitle: '모든 단어에 지도가 있습니다.',
      exploreDescription: '아직 단어 지도에 연결되지 않은 단어는 유용한 연결을 만들 때까지 이곳에 표시됩니다.',
      openExplore: '이 보기 열기',
      showAll: '전체 HSK 단어 보기',
      levelLabel: '레벨별 필터',
      allLevels: '전체 레벨',
      groupEyebrow: 'HSK 참고 목록',
      words: '개 단어',
      noMatches: '검색과 일치하는 HSK 단어가 없습니다.',
      noMatchesDescription: '다른 한자, 병음, 레벨 또는 영어 설명으로 검색해 보세요.',
      reset: '필터 초기화',
    },
